  ...
  return (
    <ScrollView style={[styles.screen, { backgroundColor: colors.bg }]} contentContainerStyle={styles.content}>
      ...
      <FadeSlideIn delay={250}>
        ...
        <AnimatedPress onPress={handleEmergency} style={[styles.emergencyBtn, { backgroundColor: '#D9383A' }]}>
          <Icon name="alert" size={18} color="#FFFFFF" />
          <Text style={[type.bodyBold, { color: '#FFFFFF', marginLeft: space.sm }]}>Emergency Alert</Text>
        </AnimatedPress>
