...
import { saveProfile, LOCAL_USER_ID } from '../lib/profileStore';
...
const styles = StyleSheet.create({
  ...
  iconCircle: { width: 68, height: 68, borderRadius: 34, alignItems: 'center', justifyContent: 'center', marginBottom: space.md },
  title: { ...type.display, marginTop: space.sm, textAlign: 'center' },
  subtitle: { ...type.body, marginTop: 4, textAlign: 'center' },
